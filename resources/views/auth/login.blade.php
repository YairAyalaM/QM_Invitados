        ...
        <div class="py-6">
            <div class="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
                ...
                <div class="w-full p-8 lg:w-1/2">
                    ...
                    <div class="mt-4">
                        <label class="block text-gray-700 text-sm font-bold mb-2" for="email" value="{{ __('Email') }}">Email Address</label>
                        <input class="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" id="email" type="email" name="email" :value="old('email')" required>
                    </div>
                    <div class="mt-4">
                        <div class="flex justify-between">
                            <label for="password" value="{{ __('Password') }}" class="block text-gray-700 text-sm font-bold mb-2">Password</label>
                            @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}" class="text-xs text-gray-500">Forget Password?</a>
                            @endif
                        </div>
                        <input class="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" type="password" type="password" name="password" required>
                    </div>
